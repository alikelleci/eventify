 ...
 * @param restoring  how many instances are restoring state stores
 * @param answered   how many instances answered; fewer than are connected means the numbers are only part of the picture
 */
public record ApplicationStatusView(String state, long stateForMs, int inState, int restoring, int answered) {
}
