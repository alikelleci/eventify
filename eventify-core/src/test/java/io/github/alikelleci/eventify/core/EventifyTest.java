  ...
  class SnapshottingTests {
    ...
    void createSnapshot() {
      List<Command> commands = List.of(
          ...
          buildAddCreditsCommand("customer-1", 1),
          buildAddCreditsCommand("customer-1", 1),
          buildAddCreditsCommand("customer-1", 1), // snapshot threshold reached
          buildAddCreditsCommand("customer-1", 1)
      );
