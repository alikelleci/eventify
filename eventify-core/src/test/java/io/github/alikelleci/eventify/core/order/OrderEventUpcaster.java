...
public class OrderEventUpcaster {
  ...
  @Upcast(type = "io.github.alikelleci.eventify.core.order.OrderEvent$OrderPlaced", revision = 1)
  public JsonNode upcastRev1(ObjectNode objectNode) {
    objectNode.put("shippingAddress", "unknown");
    return objectNode;
  }

  @Upcast(type = "io.github.alikelleci.eventify.core.order.OrderEvent$OrderPlaced", revision = 2)
