...
/**
 * The ids of messages, which are also the keys of the event store: {@code aggregateId@ULID}. All of an aggregate's
 * messages are in one key range, in the order they were created.
 */
