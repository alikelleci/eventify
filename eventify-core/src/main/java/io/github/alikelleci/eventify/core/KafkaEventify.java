...
import io.github.alikelleci.eventify.core.messaging.commandhandling.KafkaCommandProcessor;
...
import io.github.alikelleci.eventify.core.messaging.eventhandling.KafkaEventProcessor;
import io.github.alikelleci.eventify.core.messaging.eventsourcing.AggregateState;
import io.github.alikelleci.eventify.core.messaging.eventsourcing.EventSourcingHandler;
import io.github.alikelleci.eventify.core.messaging.resulthandling.KafkaResultProcessor;
...
@Slf4j
@Getter
public class KafkaEventify implements Eventify {
  ...
  protected KafkaEventify(Properties streamsConfig,
  ...
  public Topology topology() {
    ...
    if (!getCommandTopics().isEmpty()) {
      ...
      KStream<String, CommandResult> commandResults = commands
          .processValues(() -> new KafkaCommandProcessor(this), "event-store", "snapshot-store")
    ...
    if (!getEventTopics().isEmpty()) {
      ...
      // Events --> Void
      events
          .processValues(() -> new KafkaEventProcessor(this), "event-store");
    }
    ...
    if (!getResultTopics().isEmpty()) {
      ...
      // Results --> Void
      results
          .processValues(() -> new KafkaResultProcessor(this));
    }
  ...
  public static class EventifyBuilder {
    ...
    public EventifyBuilder streamsConfig(Properties streamsConfig) {
      ...
      this.streamsConfig.putIfAbsent(StreamsConfig.DEFAULT_DESERIALIZATION_EXCEPTION_HANDLER_CLASS_CONFIG,
...
//    this.streamsConfig.putIfAbsent(StreamsConfig.producerPrefix(ProducerConfig.INTERCEPTOR_CLASSES_CONFIG), interceptors);
    ...
    public KafkaEventify build() {
      ...
      KafkaEventify eventify = new KafkaEventify(
          this.streamsConfig,
          this.stateListener,
