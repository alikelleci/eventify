...
public record SnapshotPolicy(int threshold, boolean deleteEvents) {
  ...
  private static final Function<Class<?>, SnapshotPolicy> POLICY = PerClass.of(aggregateClass ->
      Optional.ofNullable(AnnotationScanner.findAnnotation(aggregateClass, EnableSnapshotting.class))
  ...
  public static SnapshotPolicy of(Class<?> aggregateClass) {
    return POLICY.apply(aggregateClass);
  }
